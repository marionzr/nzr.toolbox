...
namespace Nzr.ToolBox.Core
{
...
#endif
    {
            ...
            StringComparison stringComparison = StringComparison.OrdinalIgnoreCase)
        {
            ...
            bool appendSuffix = !value.EndsWith(suffix, stringComparison) || !onlyIfNotExisits;
            ...
            StringComparison stringComparison = StringComparison.OrdinalIgnoreCase)
        {
            ...
            bool insertPrefix = !value.StartsWith(prefix, stringComparison) || !onlyIfNotExisits;
        ...
        public static string Capitalize(this string value)
        {
            ...
            StringBuilder capitalized = new StringBuilder(value);
        ...
        public static string RemoveEnd(this string value, StringComparison stringComparison, params string[] substrings)
        {
            ...
            {
                int index = value.LastIndexOf(substring, stringComparison);
        ...
        public static bool ContainsAny(this string value, StringComparison stringComparison, params string[] substrings) =>
            value == null ? substrings.Any(s => s == null) : substrings.Any(s => value.IndexOf(s, stringComparison) >= 0);
        ...
        public static bool ContainsAll(this string value, params string[] substrings) =>
            value.ContainsAll(StringComparison.OrdinalIgnoreCase, substrings);
        ...
        public static bool ContainsAll(this string value, StringComparison stringComparison, params string[] substrings) =>
            value == null ? !substrings.Any(s => s != null) : !substrings.Any(s => value.IndexOf(s, stringComparison) == -1);
        ...
        public static string GetFirstNonEmpty(params string[] values) => values.FirstOrDefault(v => v.IsNotEmpty());
        ...
        /// <param name="values">The string values to seek.</param>
        /// <returns>The first string in the given array which is not empty, or null if none is empty.</returns>
        public static string GetFirstNonBlank(params string[] values) => values.FirstOrDefault(v => v.IsNotBlank());
        ...
        public static bool IsAllEmpty(params string[] values) => !values.Any(v => !v.IsEmpty());
        ...
        public static bool IsAllBlank(params string[] values) => !values.Any(v => !v.IsBlank());
        ...
        /// <param name="values">String values to check.</param>
        /// <returns>True if all given strings are empty.</returns>
        public static bool IsAnyEmpty(params string[] values) => values.Any(v => v.IsEmpty());
        ...
        /// <param name="values">String values to check.</param>
        /// <returns>True if all given strings are blank.</returns>
        public static bool IsAnyBlank(params string[] values) => values.Any(v => v.IsBlank());
        ...
        /// <returns></returns>
        public static string ReplaceNonNumeric(this string value, string replace = "") => value == null ? null : Regex.Replace(value, "[^0-9]", replace);
